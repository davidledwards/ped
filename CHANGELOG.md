...
### [0.43.1](https://github.com/davidledwards/ped/tree/v0.43.1) | `2026-09-08`

#### Fixed

- Cursor was not being retained in its current position after saving an _ephemeral_ editor, such as `@scratch`.
